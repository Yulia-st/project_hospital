...
<head>
<meta charset="UTF-8">
<title>Welcome page for an admin</title>
...
<body>
	<div class="containerNavig">
		...
		<div class="itemHome">
			...
			<div>
				<a class="apply-button" href="createP.jsp">Patients</a>
			</div>
		</div>
	...
	<br>
	<br>
	<h1>This page is  an admin's page</h1>
